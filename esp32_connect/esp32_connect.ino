...
//  server.send(200, "text/html", SendHTML(IMU1status)); 
//}
//
//void handle_imu1on() {
//  IMU1status = HIGH;
...
//}
//
//String SendHTML(uint8_t imu1stat){
//  String ptr = "<!DOCTYPE html> <html>\n";
//  ptr +="<head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, user-scalable=no\">\n";
//  ptr +="<meta content=\"Advait Thale\" name=\"author\"><meta content=\"20\" http-equiv=\"refresh\">\n";
//  ptr +="<title>APOLLO COMMS</title>\n";
//  ptr +="<style>html { font-family: Helvetica; display: inline-block; margin: 0px auto; text-align: center;}\n";
//  ptr +="body{margin-top: 50px;} h1 {color: #444444;margin: 50px auto 30px;} h3 {color: #444444;margin-bottom: 50px;}\n";
//  ptr +=".button {display: block;width: 80px;background-color: #3498db;border: none;color: white;padding: 13px 30px;text-decoration: none;font-size: 25px;margin: 0px auto 35px;cursor: pointer;border-radius: 4px;}\n";
...
//  
//   if(imu1stat)
//  {ptr +="<p>IMU 1: ON</p><a class=\"button button-off\" href=\"/imu1off\">OFF</a>\n";}
//  else
//  {ptr +="<p>IMU 1: OFF</p><a class=\"button button-on\" href=\"/imu1on\">ON</a>\n";}
//
//  ptr +="</body>\n";
//  ptr +="</html>\n";
//  return ptr;
