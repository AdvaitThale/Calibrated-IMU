...
void loop()
{
  ...
  Serial.print("BYTX "); Serial.print(Fx);
  Serial.print(" BYTY "); Serial.print(Fy);
  Serial.print(" BYTZ "); Serial.print(Fz);
  Serial.print(" BYTT: "); Serial.println(t);

  Serial1.print("BYTX: "); Serial1.print(Fx);
  Serial1.print(" BYTY: "); Serial1.print(Fy);
  Serial1.print(" BYTZ: "); Serial1.print(Fz);
  Serial1.print(" BYTT: "); Serial1.println(BYTT);

  //  Serial.print("BYTX "); Serial.print(AcX + AcXcal);
  //  Serial.print(" BYTY "); Serial.print(AcY + AcYcal);
  //  Serial.print(" BYTZ "); Serial.print(AcZ + AcZcal);
  //  Serial.print(" BYTT: "); Serial.println(t);
